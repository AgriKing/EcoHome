...
class _SignInState extends State<SignIn> with SingleTickerProviderStateMixin {
  ...
  Future<void> _getLocationAndSetState() async {
    bool serviceEnabled;
    ...
    if (placemarks.isNotEmpty) {
      setState(() {
        selectedState = placemarks.first.administrativeArea;
        selectedCity = placemarks.first.locality;
      });
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Detected location: $selectedState, $selectedCity")),
      );
    }
  }
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            child: DropdownButtonFormField<String>(
                              ...
                              items: [
                                // Add selectedState if not in keys
                                if (selectedState != null &&
                                    !statesAndCities.keys.contains(selectedState))
                                  DropdownMenuItem(
                                    value: selectedState,
                                    child: Text("$selectedState (Detected)"),
                                  ),
                                ...statesAndCities.keys.map(
                          ...
                          IconButton(
                            ...
                            onPressed: _getLocationAndSetState,
                      ...
                      if (selectedState != null)
                        DropdownButtonFormField<String>(
                          ...
                          items: [
                            // Add selectedCity if not in list
                            if (selectedCity != null &&
                                (!statesAndCities.containsKey(selectedState) ||
                                    !statesAndCities[selectedState]!.contains(selectedCity)))
                              DropdownMenuItem(
                                value: selectedCity,
                                child: Text("$selectedCity (Detected)"),
                              ),
                            ...?statesAndCities[selectedState]?.map(
